...
"""
Creative numbers
http://projecteuler.net/problem=616
...
or conversely remove an element c from L that can be written as a^b, with a and b being two integers such that a, b > 1, and add both a and b to LFor example starting from the list L={8}, Alice can remove 8 and add 2 and 3 resulting in L={2,3} in a first step. Then she can obtain L={9} in a second step.
