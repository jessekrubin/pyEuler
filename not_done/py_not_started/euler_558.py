...
"""
Irrational base
http://projecteuler.net/problem=558
...
More formally, for all positive integers n, we have:n = ∑_k=-∞^∞ bk rk
under the conditions that:bk is 0 or 1 for all k;bk + bk+1 + bk+2 ≤ 1 for all k;w(n) = ∑_k=-∞^∞ bk is finite.
Let S(m) = ∑_j=1^m w(j2).
