...
http://projecteuler.net/problem=556
...
z_1/z_2 = a_1 + b_1 i/a_2 + b_2 i = (a_1 + b_1 i)(a_2 - b_2 i)/(a_2 + b_2 i)(a_2 - b_2 i) = a_1 a_2 + b_1 b_2/a_2^2 + b_2^2 + a_2 b_1 - a_1 b_2/a_2^2 + b_2^2i = a_3 + b_3 i
So, z1 is divisible by z2 if a_1 a_2 + b_1 b_2/a_2^2 + b_2^2 and a_2 b_1 - a_1 b_2/a_2^2 + b_2^2 are integers.
