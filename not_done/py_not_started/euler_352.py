...
Each one of the 25 sheep in a flock must be tested for a rare virus, known to affect 2
...
We may start by running a test on a mixture of all the 25 samples. It can be verified that in about 60.35
